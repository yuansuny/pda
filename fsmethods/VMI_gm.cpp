...
#	//		cout << max_MI_learned << endl;
    ...
    strcat(results,"selFeatures_VMIgm_dataset_");
...
void VMIgm(int nsF=100, string filename="wine", int nS = 10, int nF = 10, int nC = 10){
	Nsamples =  nS;
    Nfeatures = nF;
    Nclasses = nC;
...
BOOST_PYTHON_FUNCTION_OVERLOADS(VMIgm_overloads, VMIgm, 1, 5)

BOOST_PYTHON_MODULE(VMI_gm){
    boost::python::def("VMIgm", &VMIgm, VMIgm_overloads(boost::python::args("nsF", "filename", "nS", "nF", "nC")));
}
